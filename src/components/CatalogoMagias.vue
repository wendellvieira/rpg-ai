          ...
          <template v-slot:after>
            <div class="q-pa-md">
              <div v-if="magiaSelecionada" class="magia-detalhes">
                ...
                <q-list>
                  <q-item dense>
                    ...
                    <q-item-section>
                      ...
                      <q-item-label>{{ magiaSelecionada.tempoConjuracao }}</q-item-label>
                    </q-item-section>
                  </q-item>
                  ...
                  <q-item dense>
                    ...
                    <q-item-section>
                      ...
                      <q-item-label>{{ magiaSelecionada.alcance }}</q-item-label>
                    </q-item-section>
                  </q-item>
                  ...
                  <q-item dense>
                    ...
                    <q-item-section>
                      ...
                      <q-item-label>{{ getComponentesTexto(magiaSelecionada) }}</q-item-label>
                    </q-item-section>
                  </q-item>
                  ...
                  <q-item dense>
                    ...
                    <q-item-section>
                      ...
                      <q-item-label>{{ magiaSelecionada.duracao }}</q-item-label>
                    </q-item-section>
                  </q-item>
                ...
                <!-- Efeitos -->
                <div v-if="magiaSelecionada.efeitos.length > 0" class="q-mb-md">
                ...
                <div v-if="magiaSelecionada.classes.length > 0" class="q-mb-md">
